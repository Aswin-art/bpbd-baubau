...
export function AspirationsSkeleton() {
  return (
      ...
      <header>
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <div className="mt-3 h-6 w-56 animate-pulse rounded bg-muted" />
          </div>
          <div className="h-16 w-full max-w-md animate-pulse rounded bg-muted lg:max-w-xs" />
        </div>
      </header>

      <div className="mt-12 lg:mt-16 grid gap-10 lg:grid-cols-[1fr_420px] lg:items-start">
        ...
        <div>
          <div className="h-10 w-full animate-pulse rounded bg-muted" />
          <div className="mt-6 h-5 w-56 animate-pulse rounded bg-muted" />
          <div className="mt-6 border-t border-border/70">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="border-b border-border/70 py-7">
                <div className="grid gap-4 md:grid-cols-12 md:gap-8">
                  <div className="h-4 w-10 rounded bg-muted md:col-span-1" />
                  <div className="space-y-3 md:col-span-11">
...
export function AspirationsErrorFallback({
  error,
  resetErrorBoundary,
}: FallbackProps) {
  const message =
  ...
  return (
    <Wrapper className="pt-24 pb-10 md:pt-28 xl:pt-32">
      ...
      <h1 className="mt-4 text-3xl font-bold leading-tight tracking-[-0.03em] text-secondary sm:text-4xl">
        Terjadi gangguan saat memuat aspirasi
      </h1>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-secondary">
              Tidak bisa menampilkan data aspirasi.
            </p>
