...
export const archiveDocuments: ArchiveDocument[] = [
  {
    ...
    description:
      "Kronologis lengkap, data korban, kerusakan, dan penanganan banjir di Kecamatan Batupoaro.",
  ...
  },
  {
    ...
    description:
      "Hasil investigasi penyebab longsor dan rekomendasi mitigasi di Kelurahan Kadolomoko.",
  ...
  },
  {
    ...
    description:
      "Data banjir Kelurahan Sulaa meliputi jumlah rumah terdampak dan bantuan yang disalurkan.",
  ...
  },
  {
    ...
    description:
      "Dokumentasi kerusakan dan penanganan pasca angin kencang di Kelurahan Bataraguru.",
  ...
  },
  {
    ...
    description:
      "Rekapitulasi seluruh kejadian bencana sepanjang tahun 2025 beserta evaluasi penanganan.",
  ...
  },
  {
    ...
    description:
      "Investigasi penyebab dan dampak kebakaran di Kelurahan Wajo serta rekomendasi pencegahan.",
